...
¡Bienvenido/a a este repositorio! Aquí encontrarás un compendio de **presentaciones, infografías y material educativo** enfocado en el estudio de las **Ecuaciones Diferenciales Ordinarias (EDO)** y su aplicación en **Sistemas Dinámicos**, modelos biológicos y más.
...
Este espacio busca facilitar el aprendizaje visual e intuitivo de las matemáticas aplicadas mediante infografías y guías conceptuales para estudiantes, docentes e investigadores interesados en:
...
* **Miguel Ángel Chávez García** — [@Miguelangel25Chg](https://github.com/Miguelangel25Chg)
* **Profesor de la FES Acatlán, UNAM.**

---
⭐ *Si este material te resulta útil para tus estudios o investigación, ¡no dudes en darle una estrella al repositorio!*
